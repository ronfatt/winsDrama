export interface Shot {
  ...
  shotCategory: 'Main' | 'BRoll' | 'Establishing'; // Shot Utama (Main) / B-roll Detail / Shot Suasana (Establishing)
  scene: string;
  action: string;
  character: string;
  dialogue: string;
...
export const EPISODES: Episode[] = [
  ...
  },
  {
    ...
    characters: ["Azlan", "Lina", "Panglima"],
    ...
    fullScript: [
      ...
      { section: "NASIHAT PANGLIMA", type: "action", text: "Panglima menyampuk dari meja sebelah sambil menghirup kopi." },
      { section: "NASIHAT PANGLIMA", type: "dialogue", speaker: "PANGLIMA", text: "Betul! Kalau baldi berlubang, kau tambah air sampai esok pun tetap kosong." },
      ...
      { section: "PENUTUP", type: "action", text: "Panglima menepuk bahu Azlan yang mengeluh." },
      { section: "PENUTUP", type: "dialogue", speaker: "PANGLIMA", text: "Selamat datang ke dunia bisnes sebenar!" }
    ],
    shots: [
      {
        shotNo: "2.0",
      ...
      },
      {
        ...
        visualType: "Lesson",
        shotCategory: "Main",
        scene: "Panglima berdiri memegang cawan kopi.",
        action: "Panglima memberi kiasan baldi berlubang dengan bahasa Sabah lembut.",
        character: "Panglima",
        dialogue: "PANGLIMA: “Kalau baldi berlubang, kau tambah air sampai esok pun tetap kosong.”",
        audio: "SFX: Bunyi hirupan kopi.",
        lighting: "Warm golden hour.",
        directorNote: "Karakter Panglima sebagai mentor veteran berwibawa."
      },
      {
        shotNo: "2.3b",
        ...
        visualType: "Lesson",
        shotCategory: "BRoll",
        scene: "Meja kayu Panglima.",
        action: "Asap nipis naik dari cawan kopi Hainan tradisional Panglima.",
        character: "Tiada",
        dialogue: "PANGLIMA (VO): “Ramai pandai masak, tapi pandai urus tidak ramai.”",
      ...
      },
      {
        ...
        action: "Azlan mengeluh panjang, Panglima menepuk bahunya rapat.",
        character: "Azlan & Panglima",
        dialogue: "LINA: “Buktikan dulu kau boleh urus RM100. Lepas itu baru kita bincang tentang RM10,000.”\nPANGLIMA: “Selamat datang ke dunia bisnes sebenar.”",
        audio: "BGM: Drum sting transition.",
        lighting: "Shadowing dramatic.",
        props: "Kertas Cabaran 14 Hari",
        directorNote: "Freeze frame saat Panglima menepuk bahu Azlan."
      }
    ]
  },
  {
    ...
    fullScript: [
      ...
      { section: "PEMBUKAAN", type: "action", text: "Panglima dan Lina melihat papan menu Azlan bertulis: Nasi Lemak, Mee Goreng, Burger, Ayam Goreng, Mi Sup, Kopi, Teh..." },
      { section: "PEMBUKAAN", type: "dialogue", speaker: "PANGLIMA", text: "Kau buka gerai atau buka pasar malam?" },
      ...
      { section: "STRATEGI MENU", type: "dialogue", speaker: "PANGLIMA", text: "Ini Semporna bah. Depan mata kau semua seafood!" },
    ...
    shots: [
      ...
      },
      {
        ...
        action: "Panglima menggelengkan kepala melihat papan menu Azlan.",
        character: "Panglima & Azlan",
        dialogue: "PANGLIMA: “Kau buka gerai atau buka pasar malam?”",
  ...
  },
  {
    ...
    cliffhanger: "“Kaya sudah Panglima! Jualan RM1,480!” — Lina menyampuk: “Untung berapa?”",
    locations: ["Dapur Panggang & Ruang Depan Gerai"],
    characters: ["Azlan", "Panglima", "Lina", "Pelanggan Ramai"],
    ...
    fullScript: [
      ...
      { section: "RASAN PERTAMA", type: "action", text: "Azlan menghidangkan pinggan pertama Nasi Lemak Lobster kepada Panglima." },
      { section: "RASAN PERTAMA", type: "dialogue", speaker: "AZLAN", text: "Macam mana?" },
      { section: "RASAN PERTAMA", type: "dialogue", speaker: "PANGLIMA", text: "Tambah sambal..." },
      { section: "RASAN PERTAMA", type: "action", text: "Azlan hampa, tetapi Panglima menyambung:" },
      { section: "RASAN PERTAMA", type: "dialogue", speaker: "PANGLIMA", text: "Sebab saya mau tambah satu lagi!" },
      ...
      { section: "KIRAAN JUALAN", type: "dialogue", speaker: "AZLAN", text: "RM1,480! Panglima! Kaya sudah!" },
    ...
    shots: [
      ...
      },
      {
        ...
        character: "Azlan & Lina",
        dialogue: "AZLAN: “Panglima! Kaya sudah!”\nLINA: “Untung berapa?”",
  ...
  },
  {
    ...
    characters: ["Azlan", "Panglima", "Lina"],
    ...
    fullScript: [
      ...
      { section: "PEMBUKAAN", type: "action", text: "Panglima membuka peti sejuk gerai dan mengeluarkan 4 ekor lobster yang telah rosak." },
      { section: "PEMBUKAAN", type: "dialogue", speaker: "PANGLIMA", text: "Empat lobster rosak!" },
      { section: "PEMBUKAAN", type: "dialogue", speaker: "AZLAN", text: "Sayang bah..." },
      { section: "PEMBUKAAN", type: "dialogue", speaker: "PANGLIMA", text: "Ini bukan empat lobster. Ini duit kau!" },
    ...
    shots: [
      ...
      },
      {
        ...
        action: "Panglima membuka pintu peti sejuk, memegang lobster tidak segar dengan muka berkerut.",
        character: "Panglima & Azlan",
        dialogue: "PANGLIMA: “Empat lobster rosak! Ini bukan empat lobster, ini duit kau!”",
  ...
  },
  {
    ...
    characters: ["Azlan", "Panglima", "Lina", "Content Creators / Pelanggan"],
    ...
    fullScript: [
      ...
      { section: "KRISIS KUALITI", type: "action", text: "Panglima membaca komen negatif di media sosial." },
      { section: "KRISIS KUALITI", type: "dialogue", speaker: "PANGLIMA", text: "“Makanan sedap tapi service lambat. Dulu owner friendly...”" },
      { section: "KRISIS KUALITI", type: "dialogue", speaker: "PANGLIMA", text: "Viral boleh buat orang datang sekali. Service yang buat orang datang kali kedua!" },
    ...
    shots: [
      ...
      },
      {
        ...
        visualType: "Conflict",
        shotCategory: "BRoll",
        scene: "Telefon bimbit di tangan Panglima.",
        action: "Komen TikTok bertulis 1 bintang: 'Sambal habis, lambat nak mampus'.",
        character: "Panglima (Tangan)",
        dialogue: "PANGLIMA (VO): “Dulu owner friendly...”",
      ...
      },
      {
        ...
        visualType: "Lesson",
        shotCategory: "Main",
        scene: "Panglima memegang telefon pintar menunjukkan komen.",
        action: "Azlan menunduk malu mendengar teguran Panglima.",
        character: "Panglima & Azlan",
        dialogue: "PANGLIMA: “Viral buat orang datang sekali. Service buat orang datang kali kedua!”",
  ...
  },
  {
    ...
    fullScript: [
      ...
      { section: "PENEMUAN RUANG EVENT", type: "action", text: "Panglima membawa mereka ke ruang dewan separa terbuka berhampiran Wins Garden Cafe yang tidak dimanfaatkan." },
      { section: "PENEMUAN RUANG EVENT", type: "dialogue", speaker: "PANGLIMA", text: "Tempat ini lama sudah saya fikir mau buat sesuatu..." },
    ...
    shots: [
      ...
      },
      {
        ...
        character: "Panglima, Azlan, Lina",
        dialogue: "PANGLIMA: “Tempat ini lama sudah saya fikir mau buat sesuatu...”\nAZLAN: “Kalau tempat ini kita sewakan...”",
  ...
  },
  {
    ...
    cliffhanger: "Panglima: “Ada orang tanya... kalau mau booking satu hall berapa harga?”",
    locations: ["Dewan Separa Terbuka Wins Garden Cafe"],
    characters: ["Azlan", "Lina", "Panglima", "Pelanggan Hari Jadi"],
    ...
    fullScript: [
      ...
      { section: "PENUTUP", type: "action", text: "Panglima berjalan mendekati Azlan." },
      { section: "PENUTUP", type: "dialogue", speaker: "PANGLIMA", text: "Lan... ada orang tanya. Kalau mau booking satu hall, berapa harga?" },
    ...
    shots: [
      ...
      },
      {
        ...
        visualType: "Cliffhanger",
        shotCategory: "Main",
        scene: "Panglima berdiri di pintu dewan.",
        action: "Panglima menyampaikan berita tempahan hall baharu.",
        character: "Panglima & Azlan",
        dialogue: "PANGLIMA: “Ada orang tanya... kalau mau booking satu hall berapa harga?”",
  ...
  },
  {
    ...
    characters: ["Azlan (Telah Matang)", "Lina", "Panglima", "Peniaga Muda (Bakal Azlan Baharu)", "Pekerja-pekerja Azlan"],
    ...
    fullScript: [
      ...
      { section: "KEMUNCAK ILMU", type: "action", text: "Azlan tersenyum, memandang Lina dan Panglima di belakangnya." },
      ...
      { section: "KEMUNCAK ILMU", type: "dialogue", speaker: "PANGLIMA", text: "Tapi kau sendiri kena tahu jalan!" },
    ...
    shots: [
      ...
      },
      {
        ...
        visualType: "Climax",
        shotCategory: "Main",
        scene: "Lina, Panglima dan Azlan berdiri bersama.",
        action: "Lina dan Panglima menyampaikan kata-kata azmat siri ini.",
        character: "Lina, Panglima, Azlan",
        dialogue: "LINA: “Modal boleh buka pintu.”\nPANGLIMA: “Tapi kau sendiri kena tahu jalan!”",
